    ...
    <>
      <div className="flex flex-row h-screen">
        ...
        <div className="flex-grow pb-0 mb-0">
          ...
          <div className="h-full bg-bg-gray pl-15 pt-12">
            <div className="flex flex-row">
              <div className="flex flex-col justify-center bg-light-gray w-80 h-50 mr-5 rounded-lg pb-5">
                ...
                />
                <a
                  href="https://www.youtube.com/watch?v=yL-i_sjdZdw&list=LL&index=7"
                  className="mt-3 ml-7 -mb-10 pl-7 pt-1 w-65 h-8 bg-green-blue text-white font-inter rounded-lg"
                >
              ...
              <div className="flex flex-col justify-center bg-light-gray w-80 h-50 mr-5 rounded-lg pb-5">
                ...
                />
                <a
                  href="https://www.youtube.com/watch?v=YivNfW4QFv8"
                  className="mt-3 ml-7 -mb-10 pl-12 pt-1 w-65 h-8 bg-green-blue text-white font-inter rounded-lg"
                >
                  Ordens em execução
                </a>
              </div>
              <div className="flex flex-col justify-center bg-light-gray w-80 h-50 mr-5 rounded-lg pb-5">
                ...
                />
                <a
                  href="https://www.youtube.com/watch?v=RtUjL1EYg3I"
                  className="mt-3 ml-7 -mb-10 pl-15 pt-1 w-65 h-8 bg-green-blue text-white font-inter rounded-lg"
                >
                  Ordens Finalizadas
                </a>
              </div>
            </div>
            <div className="border-r-4 border-solid border-header-blue border w-full h-full"></div>
          </div>
        </div>
      </div>
    </>
